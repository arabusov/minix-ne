...
#define VIDEO_INDEX0    11	/* video memory segment */
#define VIDEO_INDEX1    12	/* video memory segment */
...
#define VIDEO_SELECTOR0    0x59	/* (VIDEO_INDEX * DESC_SIZE + 1) */
#define VIDEO_SELECTOR1    0x61	/* (VIDEO_INDEX * DESC_SIZE + 1) */
